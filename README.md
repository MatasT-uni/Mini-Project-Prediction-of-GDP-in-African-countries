...
- **Required Libraries**: Install the necessary Python libraries using the following command:
  ...
  ```
  If a `requirements.txt` file is not available, manually install the libraries such as `pandas`, `numpy`, `scikit-learn`, and `matplotlib`.

### Installation

1. **Clone the Repository**:
   ```bash
   git clone https://github.com/MatasT-uni/Mini-Project-Prediction-of-GDP-in-African-countries.git
   cd Mini-Project-Prediction-of-GDP-in-African-countries
   ```
...
3. **Run the Scripts**:
   Open the Jupyter notebook or Python scripts provided in the `source code` folder and execute them to preprocess the data, train the models, and generate predictions.
...
- **Evaluation**: Evaluate the models' performance and visualize the results.
...
- **World Bank**: Source of economic and socio-economic data used in the project.
- **scikit-learn documentation**: Reference for the machine learning models and techniques used.
